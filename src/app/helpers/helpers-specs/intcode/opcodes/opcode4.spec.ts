...
describe('Opcode4', () => {
    ...
    describe('run', () => {
        it('should output value in position mode', async () => {
            ...
            mockExecutor.get.mockReturnValue(valueAtPosition);
        ...
        it('should output value in immediate mode', async () => {
            ...
            mockExecutor.getAtPointerAndIncrement.mockReturnValueOnce(rawCode).mockReturnValueOnce(argument);
            mockExecutor.get.mockReturnValue(immediateValue);
        ...
        it('should handle zero output value', async () => {
            ...
            mockExecutor.getAtPointerAndIncrement.mockReturnValueOnce(rawCode).mockReturnValueOnce(argument);
            mockExecutor.get.mockReturnValue(outputValue);
