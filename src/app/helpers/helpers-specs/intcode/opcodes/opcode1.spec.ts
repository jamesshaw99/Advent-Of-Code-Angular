...
describe('Opcode1', () => {
    ...
    beforeEach(() => {
        ...
        mockExecutor = {
            ...
            get: vi.fn().mockName("ProgramExecutor.get"),
    ...
    describe('run', () => {
        it('should execute addition with position mode parameters', async () => {
            ...
            mockExecutor.getAtPointerAndIncrement.mockReturnValueOnce(rawCode).mockReturnValueOnce(arg1).mockReturnValueOnce(arg2).mockReturnValueOnce(arg3);
            mockExecutor.get.mockReturnValueOnce(value1).mockReturnValueOnce(value2);
            mockExecutor.getWriteAddress.mockReturnValue(writeAddress);

            vi.spyOn(ParameterModeHelper, 'modesFromRaw').mockReturnValue([0, 0, 0]); // position modes
            vi.spyOn(opcode, 'getOpcodeInfo').mockReturnValue({ getArgsAmount: () => 3 } as OpcodeInfo);
        ...
        it('should execute addition with immediate mode parameters', async () => {
            ...
            mockExecutor.getAtPointerAndIncrement.mockReturnValueOnce(rawCode).mockReturnValueOnce(arg1).mockReturnValueOnce(arg2).mockReturnValueOnce(arg3);
            mockExecutor.get.mockReturnValueOnce(arg1).mockReturnValueOnce(arg2); // immediate mode returns the values directly
            mockExecutor.getWriteAddress.mockReturnValue(writeAddress);

            vi.spyOn(ParameterModeHelper, 'modesFromRaw').mockReturnValue([1, 1, 0]); // immediate, immediate, position
            vi.spyOn(opcode, 'getOpcodeInfo').mockReturnValue({ getArgsAmount: () => 3 } as OpcodeInfo);
        ...
        it('should execute addition with mixed parameter modes', async () => {
            ...
            mockExecutor.getAtPointerAndIncrement.mockReturnValueOnce(rawCode).mockReturnValueOnce(arg1).mockReturnValueOnce(arg2).mockReturnValueOnce(arg3);
            mockExecutor.get.mockReturnValueOnce(arg1).mockReturnValueOnce(value2); // immediate returns arg1, position returns value2
            mockExecutor.getWriteAddress.mockReturnValue(writeAddress);

            vi.spyOn(ParameterModeHelper, 'modesFromRaw').mockReturnValue([1, 0, 0]); // immediate, position, position
            vi.spyOn(opcode, 'getOpcodeInfo').mockReturnValue({ getArgsAmount: () => 3 } as OpcodeInfo);
        ...
        it('should handle zero values correctly', async () => {
            ...
            mockExecutor.getAtPointerAndIncrement.mockReturnValueOnce(rawCode).mockReturnValueOnce(args[0]).mockReturnValueOnce(args[1]).mockReturnValueOnce(args[2]);
            mockExecutor.get.mockReturnValueOnce(0).mockReturnValueOnce(0);
            mockExecutor.getWriteAddress.mockReturnValue(0);

            vi.spyOn(ParameterModeHelper, 'modesFromRaw').mockReturnValue([0, 0, 0]);
            vi.spyOn(opcode, 'getOpcodeInfo').mockReturnValue({ getArgsAmount: () => 3 } as OpcodeInfo);
        ...
        it('should handle negative numbers correctly', async () => {
            ...
            mockExecutor.getAtPointerAndIncrement.mockReturnValueOnce(rawCode).mockReturnValueOnce(args[0]).mockReturnValueOnce(args[1]).mockReturnValueOnce(args[2]);
            mockExecutor.get.mockReturnValueOnce(value1).mockReturnValueOnce(value2);
            mockExecutor.getWriteAddress.mockReturnValue(7);
        ...
        it('should call getOpcodeInfo to determine argument count', async () => {
            // Arrange
            const rawCode = 1;
            const mockOpcodeInfo = {
                getArgsAmount: vi.fn().mockName("OpcodeInfo.getArgsAmount")
            };
            mockOpcodeInfo.getArgsAmount.mockReturnValue(3);

            mockExecutor.getAtPointerAndIncrement.mockReturnValueOnce(rawCode).mockReturnValueOnce(1).mockReturnValueOnce(2).mockReturnValueOnce(3);
            mockExecutor.get.mockReturnValueOnce(10).mockReturnValueOnce(20);
            mockExecutor.getWriteAddress.mockReturnValue(3);

            vi.spyOn(ParameterModeHelper, 'modesFromRaw').mockReturnValue([0, 0, 0]);
            vi.spyOn(opcode, 'getOpcodeInfo').mockReturnValue(mockOpcodeInfo as unknown as OpcodeInfo);
