...
describe('2024 day8', () => {
    ...
    describe('processAntennas', () => {
        it('should correctly calculate antinode positions without resonance', () => {
            ...
            expect(antinodePositions.has('2,5')).toBe(true);
            expect(antinodePositions.has('8,8')).toBe(true);
        });
        ...
        it('should correctly calculate antinode positions with resonance', () => {
            ...
            expect(antinodePositions.has('0,4')).toBe(true);
            expect(antinodePositions.has('2,5')).toBe(true);
            expect(antinodePositions.has('4,6')).toBe(true);
            expect(antinodePositions.has('6,7')).toBe(true);
            expect(antinodePositions.has('8,8')).toBe(true);
            expect(antinodePositions.has('10,9')).toBe(true);
        });
    });
});
